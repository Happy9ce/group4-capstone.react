    ...
    <section id="planet-form" className="planet-form-section">
      ...
      {isSubmitted ? (
        <div className="form-success-container">
          ...
          <p className="success-greeting">Thank you, <strong>{formData.fname}</strong>!</p>
          <p className="success-details">
            We have received your message regarding planetary science. Our team will contact you shortly via <strong>{formData.contactmethod}</strong> at 
            {formData.contactmethod === 'email' ? ` ${formData.email}` : ` ${formData.numbers}`}.
          </p>
          <button className="reset-button" onClick={handleReset}>Send Another Message</button>
        </div>
      ) : (
          ...
          <div className="form-container">
            <div className={`form-field ${errors.fname ? 'has-error' : ''}`}>
              ...
              <input 
                ...
                required 
              />
              {errors.fname && <span className="field-error-msg">{errors.fname}</span>}
            </div>
            ...
            <div className={`form-field ${errors.numbers ? 'has-error' : ''}`}>
              ...
              <input 
                ...
                required 
              />
              {errors.numbers && <span className="field-error-msg">{errors.numbers}</span>}
            </div>
            ...
            <div className={`form-field ${errors.message ? 'has-error' : ''}`}>
              ...
              <div className="char-counter">
                <small>{100 - formData.message.length} characters remaining</small>
              </div>
              {errors.message && <span className="field-error-msg">{errors.message}</span>}
            </div>

            <div className="form-field form-options">
              <div className="options">
                ...
                />
                <label htmlFor="contacttext">Both</label>
              </div>
            </div>
            ...
            <div className="form-field form-options">
              <div className="options">
                ...
                <input 
                  ...
                  name="referred" 
                  value="tsacademy" 
                  checked={formData.referred.includes('tsacademy')}
                  onChange={() => handleCheckboxChange('tsacademy')}
                />
                <label htmlFor="tsacademy">TS Academy</label>
                ...
                <input 
                  ...
                  name="referred" 
                  value="others" 
                  checked={formData.referred.includes('others')}
